...
### 5.1 Dative personal pronouns

You already know the nominative (ich, du, er…) and accusative (mich, dich,
ihn…) from earlier lessons. Now add the **dative**:
...
In English "I like that" has a direct object. In German the dative is used
for several common verbs — the *experiencer* (the person with the feeling
or state) goes in the dative:
...
⚠️ **Trap!** The subject controls the verb form — if the thing liked is
plural, the verb is plural: *Die Schuhe **gefallen** mir* (not *gefällt*).
...
the **same endings** as the definite article:
...
> **Dieser** Pullover ist schön. (m, Nom)
> Ich nehme **diesen** Pullover. (m, Akk)
...
> **Welcher** Pullover gefällt dir? — Dieser hier.
> **Welche** Jacke nimmst du? — Diese rote.
> **Welchen** Schuh möchten Sie? — Diesen schwarzen.
...
**Rule:** Dative before accusative (if both are nouns).

> Ich gebe **der Verkäuferin** (Dat) **das Geld** (Akk).

**But:** pronoun(s) come before noun(s):

> Ich gebe **es** (Akk pronoun) **der Verkäuferin** (Dat noun).
> Ich gebe **ihr** (Dat pronoun) **das Geld** (Akk noun).
> Ich gebe **es ihr**. (both pronouns: Akk before Dat!)
...
- **Umlauts in clothes vocabulary:**
  - **ö** in Röcke, Größe — say "ay" with rounded lips.
  - **ü** in Hüte, Anzüge — say "ee" with rounded lips.
  - **ä** in trägt, Anzüge — **ä** sounds like the "e" in "bed": *trä*gt ≈ "treykt".
- **-ig at end of words** sounds like "-ich": *günstig* ≈ "günstiCH", *billig* ≈ "billiCH".
- The **-en ending** on verbs is often swallowed in spoken German: *anprobieren* ≈ "anprobier'n".
- **eu/äu** = "oy": *teuer* ≈ "toy-er", *Stiefel* = "STEE-fel" (no diphthong here!).

---

## 6. Lesetext: Ein neues Outfit

> Anna braucht ein Outfit für eine Party.\* Sie geht in die Stadt und sucht
