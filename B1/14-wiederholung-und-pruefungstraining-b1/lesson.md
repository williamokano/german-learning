...
> Deutsch B1 exam — all four modules (Hören, Lesen, Schreiben, Sprechen) — and
> a systematic review of every grammar topic from B1/01–13.
>
> **Grammar:** Full review — Präteritum (01), Konnektoren obwohl/trotzdem (02),
> Konjunktiv II (03), Passiv (04), Relativsätze (05), um … zu / damit (06),
> Genitiv (07), Pronominaladverbien (08), Indirekte Fragen (09), Zweiteilige
> Konnektoren (10), Bewerbungssprache (11), Nominalisierung (12),
> Schreiben-/Sprechen-Redemittel (13)
>
> **Builds on:** ALL prior B1 lessons (01–13)
...
are already there, waiting for him. Each of them has been learning or using
German at B1 level for months — and each one wants to hear how it went. In the
process, they end up reviewing everything they learned together.*

*This scene is the cast reunion for B1. It is heard as the H1a listen-first
exercise. Read it now to prime yourself; then close it and listen.*
...
| Prüfungsteil | Format | Strategie |
|---|---|---|
| Teil 1 (global) | Kurze Dialoge — Richtig/Falsch oder MC | Listen for the main point; ignore details on first pass |
| Teil 2 (detail) | Longer monologue with gaps | Note key words before listening |
| Teil 3 (selektiv) | Radio/announcement — fill gaps | Use context to predict missing words |
| Teil 4 (global) | Short statements — match to speakers | Listen for names / perspectives |

### Lesen (Lesemodul)

| Prüfungsteil | Format | Strategie |
|---|---|---|
| Teil 1 | Match headlines to texts | Read headline → skim each text for topic |
| Teil 2 | Long article — R/F/Nicht im Text | Find the exact sentence that confirms/denies |
| Teil 3 | Notice / announcement — MC | Read all options before choosing; eliminate |
| Teil 4 | Personal email or letter — R/F | Check for implied vs. stated information |

### Schreiben (Schreibmodul)

| Prüfungsteil | Format | Strategie |
|---|---|---|
| Teil 1 | Guided formal email (semi-guided) | Use the Schreib-Baukasten from B1/13 |
| Teil 2 | Forum post / informal reply | Use the Forenbeitrag-Baukasten from B1/13 |

### Sprechen (Sprechmodul)

| Prüfungsteil | Format | Strategie |
|---|---|---|
| Teil 1 | Sich vorstellen | Fixed chunks: Name, Herkunft, Beruf, Sprachen, Hobby |
| Teil 2 | Kurzpräsentation (Thema ziehen) | Einleitung → Vor-/Nachteile → Fazit (B1/13) |
| Teil 3 | Gemeinsam planen | Ask for partner's opinion; use indirect questions (B1/09) |
...
|---|---|
| die Prüfung, -en | exam |
| das Goethe-Zertifikat, -e | Goethe certificate |
| der Prüfer, – / die Prüferin, -nen | examiner |
| der Prüfling, -e | examinee, candidate |
| das Ergebnis, -se | result |
| die Aufgabe, -n | task, exercise |
| die Gliederung, -en | outline, structure |
| das Vertrauen (Sg.) | trust, confidence |
| die Nervosität (Sg.) | nervousness |
| der Hörtext, -e | listening text |
| der Lesetext, -e | reading text |
...
| Schlüsselwörter markieren | to mark key words |
...
**Bewerbung:** Bitte senden Sie Ihre vollständigen Unterlagen
(Anschreiben + Lebenslauf + Zeugnisse) bis zum **30. Juni 2026** per E-Mail an:
bewerbung@techstart-berlin.de
...
*Berlin, 14. Juni 2026* — Nach aktuellen Zahlen des Goethe-Instituts haben im
Jahr 2025 über 200.000 Menschen weltweit ein Deutschzertifikat abgelegt —
ein neuer Rekord. Besonders stark ist das Wachstum in Asien und Lateinamerika.

Das B1-Zertifikat ist dabei das am häufigsten abgelegte Niveau. „Mit einem B1
kann man in Deutschland arbeiten, studieren und sich im Alltag selbstständig
verständigen", erklärt Dr. Hilde Bauer, Leiterin des Goethe-Instituts Berlin.
„Es ist der Schlüssel zur gesellschaftlichen Teilhabe."

Allerdings sind die Prüfungen nicht kostenlos: Ein Goethe B1-Test kostet je
nach Land zwischen 100 und 250 Euro. Viele Lernende bereiten sich mit
Online-Kursen vor, weil diese günstiger sind als Präsenzkurse. Das Goethe-Institut
bietet seit 2023 auch einen vollständig digitalen Testweg an.

Kritik gibt es allerdings an der Dauer der Ergebnisbekanntgabe: Derzeit dauert
es vier bis sechs Wochen, bis Kandidatinnen und Kandidaten ihr offizielles
Zeugnis erhalten. Mehrere Sprachschulen fordern deshalb schnellere digitale
Verfahren. Das Goethe-Institut hat versprochen, die Bearbeitungszeit ab 2027
auf zwei Wochen zu verkürzen.

---

### Text 3 — Persönliche E-Mail
...
ich habe heute kurz mit Pavel gesprochen — er klang wirklich erleichtert!
Er hat mir erzählt, dass der Hörteil für ihn der schwierigste Teil war,
weil die Sprecher sehr schnell gesprochen haben. Den Leseteil fand er dagegen
gut machbar, obwohl ein Text über Stadtplanung sehr fachsprachlich war.

Das Schreiben lief gut: Er hatte schon eine klare Struktur im Kopf und musste
keine Zeit damit verschwenden, über den Aufbau nachzudenken. Er ist
wirklich ein gutes Beispiel dafür, dass regelmäßiges Üben und Vorbereitung
den Unterschied machen.

Was machst du am Wochenende? Tomáš schlägt vor, dass wir alle zusammen
feiern gehen — ob du Zeit hast?
...
> Achtung, eine Durchsage für alle Prüfungsteilnehmerinnen und Prüfungsteilnehmer des Goethe-Zertifikats B1. Bitte begeben Sie sich jetzt in den Prüfungssaal im ersten Obergeschoss. Mobiltelefone müssen ausgeschaltet und in der Tasche verstaut sein. Elektronische Hilfsmittel sind nicht erlaubt. Bitte halten Sie Ihren Lichtbildausweis bereit. Die Prüfung beginnt in fünf Minuten. Wir wünschen Ihnen viel Erfolg.
