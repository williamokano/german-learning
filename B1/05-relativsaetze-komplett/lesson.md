...
> what something is or does, use relative clauses confidently in all four cases.
>
> **Grammar:** Relative clause recap — Nominativ & Akkusativ (from A2/13) ·
> **new:** Dativ relative clauses · preposition + relative pronoun (`in dem`,
> `mit der`, `über das`…) · `was` as relative pronoun (after `alles`, `etwas`,
> `nichts`, neuter superlatives…) · `wo` for places.
>
> **Builds on:** A2/13 (relative clauses Nom & Akk — `die/der/das`, `den/die/das`) ·
> A2/08 (adjective declension — helps with gender in relative pronouns) ·
> B1/02 (connectors — relative clauses can be chained with connectors) ·
> B1/03 (Konjunktiv II — known) · B1/04 (Passiv — known).
...
schreiben. Mia schaut mit und gibt Ratschläge.*

> **Tomáš:** Also, ich brauche dringend einen guten Text für die Startseite. Die App soll kurz erklärt werden — aber präzise. Was denkt ihr?  
> **Mia:** Fang doch einfach mit einer Definition an. „Das ist eine App, mit der man …" — so etwas.  
> **Pavel:** Genau. Zum Beispiel: „Das ist eine App, mit der man in Randbezirken E-Scooter finden und mieten kann."  
> **Tomáš:** Gut! Und dann soll auch das Stadtgebiet erklärt werden. Wie formuliere ich das?  
> **Mia:** „Das ist das Stadtgebiet, in dem die Nachfrage am größten ist." — Das klingt professionell.  
> **Pavel:** Oder: „Das sind die Bezirke, in denen das Angebot bisher minimal war."  
> **Tomáš:** Super. Ich brauche auch einen Satz über unsere Nutzer. Was würdet ihr schreiben?  
> **Mia:** „Unsere Nutzer sind Menschen, denen ein schnelles und nachhaltiges Transportmittel wichtig ist."  
> **Pavel:** Ja, und dann noch etwas über das Team: „Das sind Leute, auf die du dich wirklich verlassen kannst."  
...
*Anna bespricht mit Herrn Steinmeyer ein formelles Empfehlungsschreiben, das sie
für eine Bewerbung braucht.*

> **Herr Steinmeyer:** Guten Tag, Frau Kowalski. Ich habe das Schreiben gelesen, das Sie mir gestern geschickt haben. Darf ich ein paar Anmerkungen machen?  
> **Anna:** Natürlich, Herr Steinmeyer. Ich bin für jeden Hinweis dankbar.  
> **Herr Steinmeyer:** Sehr gut. Die erste Formulierung, die ich ändern würde, ist dieser Satz hier: „Sie ist eine Mitarbeiterin, die viel leistet." Das ist zu allgemein.  
> **Anna:** Ah — wie könnte ich es konkreter formulieren?  
...
| Deutsch | English |
|---|---|
| Das ist eine App, mit der man … | That's an app with which you can … |
| Das ist ein Ort, wo / an dem man … | That's a place where you can … |
| Das ist eine Person, der/dem man vertrauen kann. | That's a person you can trust. |
| Das ist etwas, was ich jeden Tag brauche. | That's something I need every day. |
| Das ist alles, was ich wissen muss. | That's all I need to know. |
| Das ist das Beste, was mir passieren konnte. | That's the best thing that could have happened to me. |
| Das sind Menschen, denen … wichtig ist. | Those are people for whom … matters. |

### Auf etwas verweisen (referencing back to something)

| Deutsch | English |
|---|---|
| Das ist eine Formulierung, die man oft findet. | That's a phrase one often finds. |
...
|---|---|---|
| sich kümmern um (+ Akk.) | to take care of | die Kunden, um die er sich kümmert |
| abhängen von (+ Dat.) | to depend on | das Ergebnis, von dem alles abhängt |
| bestehen aus (+ Dat.) | to consist of | das Team, aus dem das Startup besteht |
| verfügen über (+ Akk.) | to have at one's disposal | die Ressourcen, über die sie verfügen |
| sich verlassen auf (+ Akk.) | to rely on | die Person, auf die man sich verlassen kann |
| achten auf (+ Akk.) | to pay attention to | die Details, auf die man achten muss |
| beitragen zu (+ Dat.) | to contribute to | das Projekt, zu dem sie beigetragen hat |
...
| Nomen | Englisch |
|---|---|
| die Formulierung, -en | formulation, phrasing |
| die Beschreibung, -en | description |
| das Merkmal, -e | characteristic, feature |
| die Eigenschaft, -en | property, quality |
| der Hinweis, -e | hint, note, pointer |
| die Zuverlässigkeit (kein Plural) | reliability |
| der Eindruck, -ü-e (die Eindrücke) | impression |
| die Bewerbungsunterlagen (Plural) | application documents |
| die Anmerkung, -en | comment, annotation, remark |
...
|---|---|---|
| der (m.) | der | Der Mann, **der** dort steht, ist mein Chef. |
| die (f.) | die | Die App, **die** kostenlos ist, hat viele Nutzer. |
...
| Genus | Pronomen | Beispiel |
|---|---|---|
| der (m.) | den | Der Mann, **den** ich kenne, heißt Tomáš. |
| die (f.) | die | Die App, **die** ich empfehle, ist kostenlos. |
...
|---|---|---|
| der (m.) | dem | Der Kollege, **dem** ich vertraue, ist sehr erfahren. |
...
|---|---|---|
| die App (f.) | mit + der | die App, **mit der** man Scooter mieten kann |
| der Kollege (m.) | von + dem | der Kollege, **von dem** ich viel gelernt habe |
...
| Antecedent | Struktur | Beispiel |
|---|---|---|
| die Ressourcen (pl.) | über + die | die Ressourcen, **über die** sie verfügen |
...
| Trigger | Beispiel |
|---|---|
| `alles` | Alles, **was** du brauchst, ist hier. |
| `etwas` | Etwas, **was** mich überrascht hat, war die Reaktion. |
| `nichts` | Nichts, **was** er sagte, war falsch. |
...
| Antecedent | Beispiel |
|---|---|
| der Ort | Das ist der Ort, **wo** wir uns kennengelernt haben. |
| die Stadt | Berlin ist die Stadt, **wo** / **in der** Pavel lebt. |
| das Land | Das ist das Land, **wo** alles möglich scheint. |
...
Wir sind ein Team, das sich leidenschaftlich für nachhaltige Mobilität einsetzt.
Unser Produkt ist eine App, mit der du in wenigen Sekunden einen E-Scooter in
deiner Nähe findest und mietest. Wir konzentrieren uns auf die Stadtgebiete, in
denen der öffentliche Nahverkehr bisher unzureichend ist — also genau dort, wo
die Menschen ihn am meisten brauchen.

Das Einzige, was uns von anderen Anbietern unterscheidet, ist unser Fokus. Wir
bieten keinen Service für das Zentrum, das sowieso gut erschlossen ist. Wir
bieten einen Service für die Randbezirke — für die Menschen, denen ein
zuverlässiges und bezahlbares Transportmittel fehlt.

Unser Team besteht aus Leuten, auf die du dich wirklich verlassen kannst. Wir
kümmern uns um alles, was du für deinen Alltag brauchst: schnelle Verfügbarkeit,
einfache Bezahlung und faire Preise. Das Ziel, für das wir jeden Tag arbeiten,
ist eine Stadt, wo jeder Mensch mobil sein kann — egal wo er wohnt.

Das Beste, was unsere Nutzer über uns sagen, ist: „Endlich eine Lösung, die
...
> Ich suche seit Monaten eine Wohnung, in der ich wirklich zur Ruhe kommen kann.
> Das Wichtigste, was ich mir wünsche, ist ein ruhiges Zimmer, in dem ich abends
> lesen und arbeiten kann. Ich brauche auch eine Küche, mit der ich richtig kochen
> kann — keine Mini-Küche, in der man kaum einen Topf abstellen kann.
> Der Bezirk, wo die Wohnung liegt, ist mir fast egal — Hauptsache, es gibt gute
> Fahrradwege, auf denen ich sicher zur Arbeit fahren kann.
> Alles, was ich brauche, ist Ruhe, Licht und eine gute Verkehrsanbindung.
