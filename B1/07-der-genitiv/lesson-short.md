...
> genitive prepositions (`wegen`, `trotz`, `während`, `statt`) correctly, recognise
> and produce n-Deklination forms, and understand the difference between the formal
> written Genitiv and the spoken `von + Dativ` alternative.
>
> **Grammar:** Genitive case (definite / indefinite / possessive articles in all
> genders) · `-(e)s` noun endings (masculine / neuter) · Genitive prepositions
> `wegen`, `trotz`, `während`, `statt` · n-Deklination (schwache Maskulina) ·
> Proper names in Genitive · `von + Dativ` vs. Genitiv register contrast.
>
> **Builds on:** A1/03 (article system — Nom/Akk) · A1/09 (Dativ — Genitiv is the
> fourth and final case) · B1/02 (`trotz` — used here correctly with Genitiv) ·
> B1/05 (Relativsätze — `dessen`/`deren` are Genitiv pronouns, noted as B2 scope).
...
> **Hannah:** Zeig mal. Wessen Fahrrad ist das? Steht da was über den Verkäufer?  
> **Layla:** Ja, der Name des Verkäufers ist Björn Koch. Er wohnt in Prenzlauer Berg. Das Fahrrad des Vorbesitzers war anscheinend kaum gefahren.  
> **Yusuf:** Und was ist der Preis des Fahrrads?  
> **Layla:** Zweihundert Euro. Ist das okay, Papa?  
> **Yusuf:** Das klingt vernünftig. Aber ich frage mich: Warum verkauft er es? Während der Woche hat man doch wenig Zeit für solche Transaktionen.  
> **Hannah:** Vielleicht wegen des Umzugs. Viele Leute verkaufen Sachen, wenn sie umziehen.  
> **Layla:** Genau! Er schreibt: „Ich verkaufe es wegen meines Umzugs nach München."  
...
> **Herr Steinmeyer:** Guten Tag, Dr. El-Sayed. Ich habe Ihren Artikel-Abstract erhalten. Grundsätzlich ist die Argumentation überzeugend. Darf ich jedoch einige sprachliche Korrekturen anmerken?  
> **Yusuf:** Selbstverständlich, Herr Steinmeyer. Ich bin dankbar für jeden Hinweis.  
> **Herr Steinmeyer:** Sie schreiben: „wegen dem globalen Wandel". Im Schriftdeutschen regiert `wegen` den Genitiv: korrekt wäre „wegen **des** globalen Wandels".  
> **Yusuf:** Ah, natürlich. Das ist ein klassischer Fehler — ich habe die gesprochene Form übernommen.  
> **Herr Steinmeyer:** Genau. Ähnliches gilt für diese Passage: „trotz dem wachsenden Druck". Korrekt: „trotz **des** wachsenden Drucks". Im Duden ist die Dativ-Variante umgangssprachlich markiert.  
> **Yusuf:** Verstanden. Und die Formulierung „während dem Symposium"?  
> **Herr Steinmeyer:** Ebenfalls: „während **des** Symposiums". Alle vier Präpositionen — `wegen`, `trotz`, `während`, `statt` — regieren im Schriftdeutschen konsequent den Genitiv.  
> **Yusuf:** Ich korrigiere das sofort. Darf ich fragen: Gilt das auch für den Titel des Artikels? Ich habe „die Theorie von einem Kollegen" geschrieben statt „die Theorie eines Kollegen".  
> **Herr Steinmeyer:** Beides ist korrekt, aber für ein akademisches Journal empfehle ich eindeutig den Genitiv. „Die Theorie eines Kollegen" ist präziser und stilistisch angemessener.  
> **Yusuf:** Herzlichen Dank, Herr Steinmeyer. Ich überarbeite das Abstract noch heute.  
...
### Formelle Schreibsprache mit Genitiv (formal written language)

| German | English |
|---|---|
| **wegen des** Umzugs | because of the move |
| **trotz des** wachsenden Drucks | despite the growing pressure |
| **während des** Symposiums | during the symposium |
| **statt des** Originals | instead of the original |
| im Rahmen **des** Projekts | within the framework of the project |
| die Ergebnisse **der** Studie | the results of the study |
| der Autor **des** Artikels | the author of the article |

### Genitiv vs. von + Dativ (register contrast)

| Formal (written) | Spoken alternative |
|---|---|
| die Meinung **des Professors** | die Meinung **vom Professor** |
| das Fahrrad **meines Vaters** | das Fahrrad **von meinem Vater** |
| die Theorie **eines Kollegen** | die Theorie **von einem Kollegen** |
| wegen **des schlechten Wetters** | wegen **dem schlechten Wetter** (colloquial) |
...
| der Vorbesitzer, – / die Vorbesitzerin, -nen | previous owner |
| der Besitzer, – / die Besitzerin, -nen | owner |
| der Besitz, -e | possession, property |
| die Zugehörigkeit (kein Plural) | belonging, affiliation |
| das Eigentum, -ü-er | property, ownership |
| der Umzug, -ü-e | move, relocation |
| das Schnäppchen, – | bargain |
| der Zustand, -ä-e | condition, state |
| das Schloss, -ö-er | lock; castle |
...
| das Abstract, -s | abstract |
| die Argumentation, -en | argumentation, line of argument |
| der Wandel (kein Plural) | change, transformation |
| der Druck (kein Plural) | pressure |
| das Symposium, Symposien | symposium, conference |
| der Kollege, -n / die Kollegin, -nen ⚠️ n-Dekl. | colleague |
| der Mensch, -en ⚠️ n-Dekl. | person, human being |
...
| regieren (+ Akkusativ / Genitiv) | to govern (case) |
...
Während der Mietdauer ist der Mieter zur ordnungsgemäßen Pflege des Mietobjekts
verpflichtet. Der Zustand der Wohnung ist bei Übergabe schriftlich festzuhalten.
Wegen etwaiger Mängel des Gebäudes ist die Hausverwaltung unverzüglich zu
informieren. Statt einer mündlichen Mitteilung ist grundsätzlich die schriftliche
Form zu bevorzugen.

Die Nutzung des Kellers sowie der gemeinschaftlichen Einrichtungen des Hauses
erfolgt auf eigene Verantwortung des Mieters. Trotz der Pflicht zur Instandhaltung
trägt der Vermieter die Kosten notwendiger Reparaturen des Daches und der
Außenwände. Die Rechte und Pflichten des Mieters sowie des Vermieters sind in den
§§ 535–580a des Bürgerlichen Gesetzbuches geregelt.

Der Mieter ist berechtigt, mit schriftlicher Genehmigung des Vermieters
Untervermietungen vorzunehmen. Während der Kündigungsfrist beider Parteien
gelten die Regelungen des vorliegenden Vertrags unverändert fort.
...
> Guten Morgen, mein Name ist Hannah El-Sayed, ich bin die Mutter Layla El-Sayeds, Schülerin der Klasse 10b. Ich rufe an, um Ihnen mitzuteilen, dass Layla heute wegen einer starken Erkältung nicht am Unterricht teilnehmen kann. Trotz ihres Wunsches, dennoch in die Schule zu gehen, habe ich ihr geraten, zu Hause zu bleiben. Während des heutigen Schultages wird sie die verpassten Aufgaben zu Hause bearbeiten. Statt der persönlichen Abgabe werde ich die Hausaufgaben meiner Tochter morgen früh beim Sekretariat abgeben. Bitte entschuldigen Sie das Fehlen meiner Tochter. Auf Wiederhören.
