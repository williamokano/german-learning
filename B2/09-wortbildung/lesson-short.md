...
### 4.1 Vorsilben (Präfixe)

Eine **Vorsilbe** (Präfix) ist eine kleine Silbe **vor** dem Verbstamm, die die
Bedeutung verändert: *ver-* (Veränderung/Abschluss), *zer-* (Trennung), *ent-*
(Entfernung/Umkehr), *miss-* (negativ/falsch), *be-* (transitiv), *er-*
(Anfang/Ergebnis), *emp-* (wie *ent-*, bei *f-/p-*), *um-* (oft trennbar),
*un-* (Negation bei Adjektiven). Wer die typische Bedeutung jeder Vorsilbe
kennt, kann ein neues Verb oft **ohne Wörterbuch** verstehen.
...
⚠️ Die häufigsten Vorsilben (*ver-, zer-, ent-, miss-, be-, er-, emp-*) sind
**untrennbar**. *Um-* ist meist trennbar (*umsteigen* — ich **steige** um).
*Un-* als Vorsilbe für Adjektive ist immer **unbetont**.

> 📌 **Merkasten — Vorsilben**
>
> ▶ Vorsilben tragen die Zusatzbedeutung. ▶ *ver-, zer-, ent-, miss-, be-, er-, emp-* sind **untrennbar**.

### 4.2 Nachsilben (Suffixe)

Die **Nachsilbe** (Suffix) kommt **nach** dem Stamm und bestimmt die Wortart.
*-ung* macht Verben zu Nomen (*lösen → Lösung*). *-heit*/*-keit* machen
Adjektive zu abstrakten Nomen (*frei → Freiheit, pünktlich → Pünktlichkeit*).
*-bar* macht Verben zu Adjektiven mit passiver Bedeutung (*bezahlen →
bezahlbar*). *-los* bildet das Gegenteil (*arbeitslos*). *-tion* und *-ment*
sind die lateinischen Entsprechungen zu *-ung* (*informieren → Information,
...
| Adjektiv (Fremdwort) | *-iv, -isch* | produktiv, kreativ, intensiv |

⚠️ *-ung* ist **feminin** (*die Lösung*), *-heit*/*-keit* ebenfalls (*die
Freiheit, die Pünktlichkeit*). *-ment* ist **neutrum** (*das Dokument, das
Engagement*). *-bar/-los/-haft/-isch/-iv* sind Adjektive und passen sich dem
Nomen in Genus, Kasus und Numerus an.

> 📌 **Merkasten — Suffixe**
>
> ▶ Suffixe bestimmen die Wortart. ▶ Sie funktionieren produktiv — du kannst sie selbst anwenden.

### 4.3 Komposita — zusammengesetzte Wörter

Ein **Kompositum** packt zwei (oder mehr) Informationen in **ein** Wort: der
**Grundbegriff** steht **rechts**, der **Bestimmbegriff** steht **links**, dazwischen
oft ein **Fugenelement** (*-s-, -n-, -en-, -er-*). Lies Komposita immer **von
rechts nach links**, um den Kern zu finden.

| Kompositum | Zerlegung | Bedeutung |
|---|---|---|
| Verkehrswende | **Verkehr** + *s* + **Wende** | die Wende im Verkehr |
| Entscheidungsträgerin | **Entscheidung** + *s* + **Träger** + *-in* | Frau, die Entscheidungen fällt |
| Umweltverträglichkeit | **Umwelt** + *s* + **Verträglichkeit** | verträglich mit der Umwelt |
| Klimaschutz | **Klima** + **Schutz** | der Schutz des Klimas |
| Hochgeschwindigkeitszug | **Hoch** + **Geschwindigkeit** + *s* + **Zug** | Zug mit hoher Geschwindigkeit |
| Wirtschaftswachstum | **Wirtschaft** + *s* + **Wachstum** | Wachstum der Wirtschaft |

⚠️ Fugenelemente (*-s-, -n-, -en-, -er-*) erleichtern die Aussprache; sie haben
**keine eigene Bedeutung**. Bei Unsicherheit hilft der **Duden** (Online­wörter­buch
trennt Komposita mit senkrechten Strichen *|*).
...
### 4.4 Wortfamilien — vom Verb zum Nomen und zurück

Eine **Wortfamilie** kreist um denselben Stamm: das Verb, das Nomen, die
Person, das Adjektiv, das Kompositum, die Negation mit *un-*, die Variante mit
*miss-*. Wer den Stamm kennt, hat das halbe Wortfeld.

| Stamm | Verb | Nomen (Person) | Nomen (Sache) | Adjektiv | Kompositum |
|---|---|---|---|---|---|
| **entscheid-** | entscheiden | Entscheider/Entscheiderin | Entscheidung | entscheidend | Entscheidungsträger |
| **fahr-** | fahren | Fahrer/Fahrerin | Fahrt, Fahrkarte | fahrbar, unfahrbar | Fahrschule, Erfahrung |
| **zahl-** | zahlen | Zahler/Zahlerin | Zahlung, Bezahlung | bezahlbar | Bezahlbarkeit |
| **versteh-** | verstehen | Versteher/Versteherin | Verständnis | verständlich / unverständlich | Missverständnis |
| **empfind-** | empfinden | — | Empfindung | empfindlich / unempfindlich | Empfindsamkeit |

⚠️ *-in* als Endung zeigt **immer die weibliche Form** an: *der Träger → die
Trägerin*, *der Entscheider → die Entscheiderin*, *der Mitarbeiter → die
Mitarbeiterin*.

> 📌 **Merkasten — Wortfamilien**
>
> ▶ Wortfamilien sparen Vokabelarbeit. ▶ Wer den Stamm kennt, hat das halbe Wortfeld.

---

## 5. Lesetext — Wie funktioniert deutsche Wortbildung?
...
## 6. Hörtext — Annas Erklärung im Sprachkurs
...
## 7. Lernstrategie — Wortbildung meistern

1. **Markiere die Bausteine.** Nimm jedes neue Wort auseinander: Vorsilbe,
   Stamm, Suffix. So siehst du auf einen Blick, welche Teile **produktiv**
   sind (sich wiederholen) und welche **unikat** sind.
2. **Lern Wortfamilien statt Einzelwörter.** Drei Beispiele pro Verb reichen:
   das Nomen auf *-ung*, das Adjektiv auf *-bar*, die Person auf *-er*. Aus
   *erfahren* werden so *Erfahrung*, *erfahrbar* und *Erfahrener* — drei Wörter
   gratis.
3. **Lies Komposita von rechts nach links.** Der Grundbegriff steht rechts. Wenn
   du *Verkehrswende* hörst, frag dich: Welche *Wende*? Eine *Verkehrs*wende.
4. **Such im echten Text.** Eine Zeitungsseite (taz, FAZ, Süddeutsche) aufschlagen,
   zehn unbekannte Wörter heraussuchen, zerlegen und Bedeutung erschließen.
   Das trainiert das System mehr als jede Übung.
